...
echo -e "1. Edit the ${BOLD}.env${NC} file with your configuration:"
echo -e "   ${BLUE}nano .env${NC}  ${YELLOW}# or use your preferred editor${NC}\n"
echo -e "2. Set TEST_TARGET in .env:"
echo -e "   - ${YELLOW}cribl${NC} - Test Cribl only"
echo -e "   - ${YELLOW}splunk${NC} - Test Splunk only (default)"
echo -e "   - ${YELLOW}both${NC} - Test both Cribl and Splunk\n"
echo -e "3. Configure required values based on your testing target:\n"
echo -e "   ${BOLD}For Cribl testing (TEST_TARGET=cribl or both):${NC}"
echo -e "   - CRIBL_HTTP_URL"
echo -e "   - CRIBL_API_URL"
echo -e "   - CRIBL_CLIENT_ID"
echo -e "   - CRIBL_CLIENT_SECRET"
echo -e "   ${YELLOW}Generate API credentials in Cribl: Settings → API Credentials${NC}\n"
...
echo -e "4. When ready, activate the virtual environment and run HEC-Yeah:"
